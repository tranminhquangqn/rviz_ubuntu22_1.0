...
: ${AMENT_CURRENT_PREFIX:="/home/quang/Downloads/rviz_ubuntu22_1.0/install/rviz_rendering"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rviz_rendering/environment/library_path.sh"
