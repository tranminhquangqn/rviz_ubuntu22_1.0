...
: ${AMENT_CURRENT_PREFIX:="/home/quang/Downloads/rviz_ubuntu22_1.0/install/rviz_common"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rviz_common/environment/library_path.sh"
